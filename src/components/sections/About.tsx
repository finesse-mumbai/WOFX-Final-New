...
export function About() {
  ...
  return (
    <section ref={sectionRef} className="bg-brand-gray text-zinc-900 border-y border-[#AAD24E]/30 relative overflow-hidden">
      <div className="w-[95%] mx-auto border-x border-[#AAD24E]/30 relative">
        ...
        <div className="flex flex-col md:flex-row relative">
          ...
          <div className="flex-1 py-8 px-6 md:px-20 space-y-12 relative">
            ...
            <button className="flex items-center space-x-8 bg-brand-magenta text-white px-10 py-3 rounded-none font-bold hover:bg-brand-purple transition-all group w-fit text-xl">
              <span>Read More</span>
